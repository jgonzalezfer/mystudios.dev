...
const NewsLatterBox = () => {
  ...
  return (
    ...
    >
      ...
      Suscríbete para Recibir Actualizaciones Futuras
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
      Permanece al tanto de las últimas novedades y 
      desarrollos emocionantes suscribiéndote a nuestro boletín. Nos encantaría compartir contigo las últimas actualizaciones y noticias relevantes sobre mystudio.dev.
      </p>
      <div>
        <input
          type="text"
        ...
        Garantizamos la ausencia de spam, así que por favor, abstente de enviar correos no deseados.        </p>
      </div>
